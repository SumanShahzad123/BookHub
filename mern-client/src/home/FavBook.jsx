  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
            <img src={FavBookImg} alt='rounded md:w-10/12' />
        </div>
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate sunt quia sint. Quibusdam, fugiat totam veritatis sunt maxime alias quidem quae eaque pariatur vero quasi nihil minima natus deleniti ratione?
            </p>
